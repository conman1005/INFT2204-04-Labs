...
((core) =>
{
    ...
    function performLogin()
    {
      ...
      $.get("./Data/users.json", function(data)
      {
        ...
        if(success)
        {
          ...
          // replaced location.href with router.ActiveLink and using Start() method after because redirecting after logging in or out did not work using location.href
    ...
    function toggleLogin()
    {
      ...
      // Add Task List to Task Bar
      $(`<li class="nav-item">
      <a id="task-list" class="nav-link" aria-current="page"><i class="fa fa-list" aria-hidden="true"></i> Task List</a>
    </li>`).insertBefore("#loginListItem");
      }
      else
      {
    ...
    function ActiveLinkCallBack(activeLink)
    {
      ...
      switch (activeLink) 
      {
        ...
        // Add Contact List to ActiveLinkCallBack Method and return DisplayTaskList
